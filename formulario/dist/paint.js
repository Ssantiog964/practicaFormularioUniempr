...
const addStudent=(name,lastName, mail, cargo, tele, msn) =>{
    let person ={
        pname: name,
        plastName : lastName,
        pmail: mail,
...
const addProfesor=(name,lastName, mail, cargo, tele, msn) =>{
    let person ={
        pname: name,
        plastName : lastName,
        pmail: mail,
...
function modalAlert(cad, tipo, persona){
    ...
    if(tipo==="aceptar"){       
        ...
        btnEnviar.onclick = function(){
            //cuando se da un click se pinta la persona
            paintCard(persona, "");
...
const paintCard = (datos, tipo) =>{
    ...
    if(tipo === "ESTUDIANTE"){
        ...
        tempTemplate.querySelector('.text-select').innerHTML = `CARGO: ${datos.pcargo} `;
        ...
        tempTemplateT.querySelector('.text-select').innerHTML = `CARGO: ${datos.pcargo} `;
